...
public class ZombieSpawn : MonoBehaviour
{
    ...
    void Leveller()
    {
        ...
        {
            Instantiate(Zombi_5, new Vector3(128, 0, 32), gameObject.transform.rotation);
        ...
        {
            Instantiate(Zombi_10, new Vector3(205, 0, 32), gameObject.transform.rotation);
        ...
        else if (ButtonManager.level == 5)
        {
            ...
            Instantiate(Zombi_10, new Vector3(180, 0, -60), gameObject.transform.rotation);
        }
        else if (ButtonManager.level == 6)
        {
            Instantiate(Zombi_10, new Vector3(179, 0, -131), gameObject.transform.rotation);
            Instantiate(Zombi_5, new Vector3(214, 0, -131), gameObject.transform.rotation);            
        }
        else if (ButtonManager.level == 7)
        {
            Instantiate(Zombi_10, new Vector3(274, 0, -108), gameObject.transform.rotation);
            Instantiate(Zombi_10, new Vector3(280, 0, -111), gameObject.transform.rotation);
        }
        else if (ButtonManager.level == 8)
        {
            Instantiate(Zombi_10, new Vector3(350, 0, -111), gameObject.transform.rotation);
            Instantiate(Zombi_10, new Vector3(352, 0, -113), gameObject.transform.rotation);
        }
        else if (ButtonManager.level == 9)
        {
            Instantiate(Zombi_10, new Vector3(403, 0, -108), gameObject.transform.rotation);
            Instantiate(Zombi_10, new Vector3(408, 0, -115), gameObject.transform.rotation);
        ...
        else if (ButtonManager.level == 10)
        {
            ...
            Instantiate(Zombi_10, new Vector3(482, 0, -115), gameObject.transform.rotation);
            Instantiate(Zombi_10, new Vector3(474, 0, -109), gameObject.transform.rotation);
        }
        else
        {
